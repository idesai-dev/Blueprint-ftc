...
<svelte:head>
	...
	<meta name="description" content="FTC outreach documentation: running events, judging, awards, and growing your program." />
</svelte:head>
		...
		<div class="content-feed">
			<section class="blog-header">
				<div class="blog-header-inner">
					...
					<a href="/review?tab=portfolio" class="review-link">Get a Portfolio Review →</a>
				</div>
			</section>

			<section class="index-section">
				<div class="container">
					<DocIndex posts={data.posts} section="outreach" />
				</div>
			</section>
		</div>
	</div>
